...
import {createPerson, getPeople, Person} from "../../api/personApiClient";

describe('personApiClient', () => {
  it('should make a GET request to get people when getPeople is called', async () => {
    const expectedPeople: Person[] = [{firstName: 'Josh', lastName: 'White'}, {firstName: 'Colton', lastName: 'White'}];
  ...
  it('should make a POST request to create a person when createPerson is called', async () => {
    ...
    }).post('/person', {firstName: "Josh", lastName: "White"})
